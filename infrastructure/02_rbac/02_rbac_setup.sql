...
-- Temporarily disable MIN_AGE to allow password change
ALTER PASSWORD POLICY MEDICORE_GOVERNANCE_DB.SECURITY.MEDICORE_PASSWORD_POLICY SET PASSWORD_MIN_AGE_DAYS = 0;

ALTER USER SVC_GITHUB_ACTIONS_MEDICORE SET 
    PASSWORD = 'Snowflake!CICD_2024x'
    DISABLED = FALSE;

-- Restore MIN_AGE (adjust value as needed for your policy)
ALTER PASSWORD POLICY MEDICORE_GOVERNANCE_DB.SECURITY.MEDICORE_PASSWORD_POLICY SET PASSWORD_MIN_AGE_DAYS = 1;
...
GRANT APPLY ON TAG MEDICORE_GOVERNANCE_DB.TAGS.PHI_CLASSIFICATION TO ROLE MEDICORE_DATA_ENGINEER;
...
GRANT APPLY ON TAG MEDICORE_GOVERNANCE_DB.TAGS.PHI_CLASSIFICATION TO ROLE MEDICORE_SVC_GITHUB_ACTIONS;
